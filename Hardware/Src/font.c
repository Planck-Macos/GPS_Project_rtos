...
// 8×8 ASCII字模数组（示例：仅包含0-9、A-Z、a-z、空格等常用字符，可扩展）
// 字模生成规则：横向8列，每列1字节（8位），高位在上、低位在下
...
// 16×16汉字点阵数组（按页取模：前16字节=上8行16列，后16字节=下8行16列）
const unsigned char zh16x16[][32] = {
...
0x22,0x67,0x22,0x12,0x12,0x12,0x40,0x42,0x42,0x42,0x7E,0x42,0x42,0x42,0x40,0x00},/*"经",4*/
/* (16 X 16 , 宋体 )*/

{0x20,0x30,0xAC,0x63,0x20,0x18,0x00,0x08,0x48,0x48,0xFF,0x48,0x48,0x48,0x08,0x00,
0x22,0x67,0x22,0x12,0x12,0x12,0x00,0x02,0x02,0x02,0xFF,0x02,0x12,0x22,0x1E,0x00},/*"纬",5*/
...
//需要注意，从字模取字软件得到的字模是取得8*16格式的字，但实际上汉字是16*16；所以把两个数组合并
{0x40,0x40,0x42,0x42,0x42,0x42,0x42,0xFE,0x42,0x42,0x42,0x42,0x42,0x40,0x40,0x00,
0x80,0x80,0x40,0x20,0x10,0x0C,0x03,0x00,0x03,0x0C,0x10,0x20,0x40,0x80,0x80,0x00},/*"天",0*/
...
0x01,0x00,0x20,0x70,0x28,0x26,0x21,0x20,0x20,0x24,0x38,0x60,0x00,0x01,0x01,0x00},/*"公",3*/
